"""
Django settings for seolynn project.
...
TEMPLATES = [
    {
        ...
        'DIRS': ['./templates', f'{os.path.join(BASE_DIR, "templates")}'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'seolynn.wsgi.application'
...
# For Django_registration Plugin
